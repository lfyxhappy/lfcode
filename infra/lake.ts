...
const tableBucketName = `lfcode-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `lfcode-${$app.stage}-lake-ingest`,
    destination: "iceberg",
