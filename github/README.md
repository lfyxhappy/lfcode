...
A GitHub Action that integrates [Lfcode](https://github.com/lfyxhappy/lfcode) directly into your GitHub workflow.

Mention `/opencode` in your comment, and Lfcode will execute tasks within your GitHub Actions runner.
