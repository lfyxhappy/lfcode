...
- `Lfcode` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `Lfcode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `Lfcode` inside commands, URLs, package names, or code literals
