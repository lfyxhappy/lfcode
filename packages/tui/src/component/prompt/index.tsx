...
import type { AssistantMessage, FilePart, UserMessage } from "@lfcode-ai/sdk/v2"
...
import { LFCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useLfcodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.LFCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
