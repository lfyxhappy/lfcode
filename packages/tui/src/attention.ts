...
} from "@lfcode-ai/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@lfcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@lfcode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@lfcode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@lfcode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@lfcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@lfcode-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "lfcode"
const DEFAULT_PACK_ID = "lfcode.default"
