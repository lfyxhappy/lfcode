...
declare const LFCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof LFCODE_CLI_NAME === "string" ? LFCODE_CLI_NAME : "lfcode", {
  description: "Lfcode 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
