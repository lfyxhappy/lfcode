...
const statsHomeTitle = "Lfcode Data"
const statsHomeDescription = "Lfcode usage data, market share, token cost, and session cost."
const statsHomeFallbackUrl = "https://lfcode.ai/data/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.lfcode.ai") return "https://lfcode.ai/data/"
  if (url.hostname === "stats.dev.lfcode.ai") return "https://dev.lfcode.ai/data/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across Lfcode Go.</span>
      </h2>
      <Show
