...
beforeAll(async () => {
  ...
  mock.module("@lfcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@lfcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@lfcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@lfcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
