export const dict = {
  ...
  "dialog.provider.lfcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.lfcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.lfcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Lfcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Lfcode.",
  ...
  "provider.connect.lfcodeZen.line1":
    "Lfcode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.lfcodeZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.lfcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.lfcodeZen.visit.link": "lfcode.ai/zen",
  "provider.connect.lfcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Lfcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Lfcode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w lfcode.json",
  ...
  "dialog.server.description": "Przełącz serwer Lfcode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Lfcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Lfcode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (lfcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Lfcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Lfcode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Lfcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Lfcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Lfcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Lfcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Lfcode.",
