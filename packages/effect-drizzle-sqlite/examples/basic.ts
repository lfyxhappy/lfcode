...
class Database extends Context.Service<Database, DatabaseShape>()("@lfcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@lfcode/example/UserStore") {
