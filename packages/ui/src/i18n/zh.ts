...
export const dict = {
  ...
  "ui.fileReference.browseInApp": "在应用内浏览",
  ...
  "ui.sessionTurn.status.commandGroup": "运行了多个命令",
  "ui.sessionTurn.status.toolGroup": "调用了多个工具",
  ...
  "ui.webSearch.route": "搜索路由",
  "ui.webSearch.queryOriginal": "原始查询",
  "ui.webSearch.querySent": "实际查询",
  "ui.webSearch.fidelity": "查询保真度",
  "ui.webSearch.attempts": "降级链路",
