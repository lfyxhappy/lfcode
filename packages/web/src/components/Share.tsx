...
import { IconLfcode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "@lfcode-ai/cli/session/message-v2"
import type { Message } from "@lfcode-ai/cli/session/message"
import type { Session } from "@lfcode-ai/cli/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.lfcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.lfcode_name}>
                    <IconLfcode width={16} height={16} />
                  </div>
