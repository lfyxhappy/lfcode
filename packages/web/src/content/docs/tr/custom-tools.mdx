---
title: Özel Araçlar
description: LLM'un lfcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. lfcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.lfcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/lfcode/tools/` içine yerleştirerek.
