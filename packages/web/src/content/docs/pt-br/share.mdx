---
title: Compartilhar
description: Compartilhe suas conversas do lfcode.
---

O recurso de compartilhamento do lfcode permite que você crie links públicos para suas conversas do lfcode, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o lfcode:

1. Cria uma URL pública única para sua sessão
2. Sincroniza seu histórico de conversas com nossos servidores
3. Torna a conversa acessível através do link compartilhável — `lfcode.ai/s/<share-id>`

---

## Compartilhamento

O lfcode suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o lfcode usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `lfcode.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o lfcode em sua organização.
