---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala lfcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

lfcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie lfcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI lfcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do lfcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij lfcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `lfcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Lfcode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `lfcode.default`.
