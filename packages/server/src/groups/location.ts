...
import { LocationServiceMap } from "@lfcode-ai/core/location-layer"
...
function ref(request: HttpServerRequest.HttpServerRequest): Location.Ref {
  ...
  const workspaceID = query.get("location[workspace]") || request.headers["x-lfcode-workspace"]
  return Location.Ref.make({
    directory: AbsolutePath.make(
      query.get("location[directory]") || request.headers["x-lfcode-directory"] || process.cwd(),
    ),
