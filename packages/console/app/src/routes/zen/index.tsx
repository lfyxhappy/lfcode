...
import compareVideo from "../../asset/lander/lfcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/lfcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="lfcode:auth" content={loggedin() ? "true" : "false"} />
