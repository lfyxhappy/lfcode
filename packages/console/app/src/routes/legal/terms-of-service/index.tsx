...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Lfcode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Lfcode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Lfcode. Please read on to learn the rules and restrictions that govern your use of
                Lfcode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Lfcode," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://lfcode.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-lfcode">What is Lfcode?</h2>
              <p>
                Lfcode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Lfcode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Lfcode enables you to
              ...
              <p>
                ...
                our site located at lfcode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Lfcode takes the privacy of its users very seriously. For the current Lfcode Privacy Policy, please
                click here{" "}
                <a href="https://lfcode.ai/legal/privacy-policy">https://lfcode.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Lfcode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Lfcode;
                </li>
                <li>
              ...
              <p>
                If you use Lfcode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Lfcode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Lfcode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-lfcode-ever-change-the-services">Will Lfcode ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://lfcode.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://lfcode.ai/auth">https://lfcode.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://lfcode.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Lfcode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Lfcode has the sole right to decide whether you are
              ...
              <p>
                Lfcode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Lfcode and all such
                parties together, the "Lfcode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Lfcode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Lfcode Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY LFCODE (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                LFCODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO LFCODE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Lfcode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Lfcode's prior written
              ...
              <p>
                ...
                disputes and claims with Lfcode and limits the manner in which you can seek relief from Lfcode. Both
                you and Lfcode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Lfcode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Lfcode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Lfcode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Lfcode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND LFCODE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Lfcode are instead choosing to have claims and disputes resolved by
                ...
                you and Lfcode over whether to vacate or enforce an arbitration award, YOU AND LFCODE WAIVE ALL
              ...
              <p>
                ...
                Lfcode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Lfcode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Lfcode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Lfcode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Lfcode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Lfcode, and
                ...
                are not an employee, agent, partner, or joint venture of Lfcode, and you do not have any authority of
                any kind to bind Lfcode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Lfcode
