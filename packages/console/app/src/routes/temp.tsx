    ...
    <main data-page="home">
      ...
      <div data-component="content">
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>@lfcode-ai/cli</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>@lfcode-ai/cli</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/lfcode">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/lfyxhappy/lfcode">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://discord.gg/lfcode">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
