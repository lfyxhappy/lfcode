...
const dir = path.join(os.tmpdir(), "lfcode-test-data-" + process.pid)
...
process.env["LFCODE_TEST_TMPDIR_ROOT"] = fixtureRoot
afterAll(async () => {
...
process.env["LFCODE_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["LFCODE_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["LFCODE_DISABLE_DEFAULT_PLUGINS"] = "true"

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "lfcode")
...
delete process.env["LFCODE_SERVER_PASSWORD"]
delete process.env["LFCODE_SERVER_USERNAME"]
delete process.env["LFCODE_HOME"]

// Use in-memory sqlite
process.env["LFCODE_DB"] = ":memory:"
