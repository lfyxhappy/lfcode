...
describe("WorkflowTool run", () => {
  ...
  const originalFlag = Flag.LFCODE_EXPERIMENTAL_WORKFLOW_TOOL
  beforeAll(() => {
    Flag.LFCODE_EXPERIMENTAL_WORKFLOW_TOOL = true
  })
  afterAll(() => {
    Flag.LFCODE_EXPERIMENTAL_WORKFLOW_TOOL = originalFlag
  })
