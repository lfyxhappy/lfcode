...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/lfcode-ai/lfcode.git")).toEqual({ owner: "lfcode-ai", repo: "lfcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/lfcode-ai/lfcode")).toEqual({ owner: "lfcode-ai", repo: "lfcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:lfcode-ai/lfcode.git")).toEqual({ owner: "lfcode-ai", repo: "lfcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:lfcode-ai/lfcode")).toEqual({ owner: "lfcode-ai", repo: "lfcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/lfcode-ai/lfcode.git")).toEqual({ owner: "lfcode-ai", repo: "lfcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/lfcode-ai/lfcode")).toEqual({ owner: "lfcode-ai", repo: "lfcode" })
})
