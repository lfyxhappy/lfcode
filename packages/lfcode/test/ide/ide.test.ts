...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LFCODE_CALLER", () => {
    process.env["LFCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LFCODE_CALLER", () => {
    process.env["LFCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LFCODE_CALLER", () => {
    process.env["LFCODE_CALLER"] = "unknown"
