...
export const dict = {
  ...
  "tui.tips.tab_agent":
    "按 {highlight}Tab{/highlight} 或 {highlight}Shift+Tab{/highlight} 在 Build / Plan 智能体之间切换",
  "tui.tips.theme_mode":
  ...
  "tui.tips.share": "运行 {highlight}/share{/highlight} 在 lfcode.ai 上为你的对话生成公开链接",
  ...
  "tui.tips.config_files":
    "创建 {highlight}lfcode.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/lfcode/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "Lfcode 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.lfcode/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.lsp": "Lfcode 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.lfcode/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.lfcode/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 Lfcode 读取敏感文件",
  "tui.tips.run": "用 {highlight}lfcode run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}lfcode --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}lfcode run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}lfcode serve{/highlight} 以无头模式提供 Lfcode API",
  "tui.tips.attach_server": "用 {highlight}lfcode run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}lfcode upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}lfcode auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}lfcode agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/lfcode{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}lfcode github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.lfcode/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}lfcode debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.docker": "在容器环境中运行 Lfcode，获得隔离的开发环境",
  "tui.tips.zen": "搭配 Lfcode Zen 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.command.lfcode.status.title": "查看状态",
  ...
  "tui.voice.error.no_auth": "请先选择已配置且支持音频输入的 OpenAI 兼容模型",
  "tui.voice.error.no_recorder": "未检测到录音工具，请安装 sox",
  "tui.voice.install.title": "安装录音器",
  "tui.voice.install.message": "当前未检测到可用录音器。是否现在安装受管 SoX，并在安装完成后继续开启语音输入？",
  "tui.voice.install.confirm": "安装",
  "tui.voice.install.installing": "正在安装受管 SoX...",
  "tui.voice.install.success": "受管 SoX 安装完成，语音输入已可继续使用。",
  "tui.voice.install.failed": "安装受管 SoX 失败：",
