...
export const dict = {
  ...
  "tui.tips.tab_agent":
    "Appuyez sur {highlight}Tab{/highlight} ou {highlight}Shift+Tab{/highlight} pour basculer entre les agents Build et Plan",
  "tui.tips.theme_mode":
  ...
  "tui.tips.share":
    "Exécutez {highlight}/share{/highlight} pour créer un lien public vers votre conversation sur lfcode.ai",
  ...
  "tui.tips.config_files":
    "Créez {highlight}lfcode.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/lfcode/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "Lfcode gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.lfcode/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.lsp": "Lfcode utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.lfcode/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.lfcode/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher Lfcode de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}lfcode run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}lfcode --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}lfcode run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}lfcode serve{/highlight} pour exposer l'API Lfcode en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}lfcode run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}lfcode upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}lfcode auth list{/highlight} pour voir tous les fournisseurs configurés",
  "tui.tips.agent_create":
    "Exécutez {highlight}lfcode agent create{/highlight} pour créer un agent en mode guidé",
  "tui.tips.github_trigger":
    "Utilisez {highlight}/lfcode{/highlight} dans les issues/PR GitHub pour déclencher des actions IA",
  "tui.tips.github_install":
    "Exécutez {highlight}lfcode github install{/highlight} pour configurer le workflow GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.lfcode/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}lfcode debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker": "Exécutez Lfcode dans votre environnement de conteneur pour un développement isolé",
  "tui.tips.zen":
    "Utilisez {highlight}/connect{/highlight} avec Lfcode Zen pour des modèles testés et sélectionnés",
  "tui.tips.agents_md":
  ...
  "tui.command.lfcode.status.title": "Voir l'état",
  ...
  "tui.voice.error.no_auth": "Sélectionnez d'abord un modèle compatible OpenAI avec entrée audio",
