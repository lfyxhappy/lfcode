...
export const dict = {
  ...
  "tui.tips.share": "執行 {highlight}/share{/highlight} 在 lfcode.ai 上為你的對話產生公開連結",
  ...
  "tui.tips.config_files":
    "建立 {highlight}lfcode.json{/highlight} 用於伺服器端設定，{highlight}tui.json{/highlight} 用於 TUI 設定",
  "tui.tips.global_config": "把 TUI 設定放在 {highlight}~/.config/lfcode/tui.json{/highlight} 作為全域設定",
  ...
  "tui.tips.mcp_oauth": "Lfcode 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.lfcode/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.lsp": "Lfcode 使用 LSP 伺服器進行智慧程式碼分析",
  "tui.tips.custom_tool":
    "在 {highlight}.lfcode/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins":
    "在 {highlight}.lfcode/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  "tui.tips.plugin_notify": "用外掛在工作階段完成時傳送系統通知",
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 Lfcode 讀取敏感檔案",
  "tui.tips.run": "用 {highlight}lfcode run{/highlight} 進行非互動式指令稿呼叫",
  "tui.tips.continue": "用 {highlight}lfcode --continue{/highlight} 繼續上一個工作階段",
  "tui.tips.attach_cli": "用 {highlight}lfcode run -f file.ts{/highlight} 透過命令列附加檔案",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在指令稿中取得機器可讀輸出",
  "tui.tips.serve": "執行 {highlight}lfcode serve{/highlight} 以無介面模式提供 Lfcode API",
  "tui.tips.attach_server": "用 {highlight}lfcode run --attach{/highlight} 連線到正在執行的服務",
  "tui.tips.upgrade": "執行 {highlight}lfcode upgrade{/highlight} 升級到最新版本",
  "tui.tips.auth_list": "執行 {highlight}lfcode auth list{/highlight} 檢視所有已設定的供應商",
  "tui.tips.agent_create": "執行 {highlight}lfcode agent create{/highlight} 引導式建立智慧代理",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中輸入 {highlight}/lfcode{/highlight} 觸發 AI 操作",
  "tui.tips.github_install": "執行 {highlight}lfcode github install{/highlight} 設定 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.lfcode/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.tips.debug_config": "執行 {highlight}lfcode debug config{/highlight} 排查設定問題",
  ...
  "tui.tips.docker": "在容器環境中執行 Lfcode，取得隔離的開發環境",
  "tui.tips.zen": "搭配 Lfcode Zen 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
  ...
  "tui.command.lfcode.status.title": "檢視狀態",
  ...
  "tui.voice.error.no_auth": "請先選擇已設定且支援音訊輸入的 OpenAI 相容模型",
  "tui.voice.error.no_recorder": "未偵測到錄音工具，請安裝 sox",
  "tui.voice.install.title": "安裝錄音器",
  "tui.voice.install.message": "目前未偵測到可用錄音器。是否現在安裝受管 SoX，並在安裝完成後繼續開啟語音輸入？",
  "tui.voice.install.confirm": "安裝",
  "tui.voice.install.installing": "正在安裝受管 SoX...",
  "tui.voice.install.success": "受管 SoX 安裝完成，語音輸入已可繼續使用。",
  "tui.voice.install.failed": "安裝受管 SoX 失敗：",
