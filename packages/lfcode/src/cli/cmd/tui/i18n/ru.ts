...
export const dict = {
  ...
  "tui.tips.tab_agent":
    "Нажмите {highlight}Tab{/highlight} или {highlight}Shift+Tab{/highlight}, чтобы переключаться между агентами Build и Plan",
  "tui.tips.theme_mode":
  ...
  "tui.tips.share":
    "Выполните {highlight}/share{/highlight}, чтобы получить публичную ссылку на диалог на lfcode.ai",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}lfcode.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/lfcode/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "Lfcode автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.lfcode/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.lsp": "Lfcode использует LSP-серверы для интеллектуального анализа кода",
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.lfcode/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.lfcode/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.plugin_protect":
    "Создайте плагин, который запретит Lfcode читать чувствительные файлы",
  "tui.tips.run":
    "Используйте {highlight}lfcode run{/highlight} для неинтерактивных скриптов",
  "tui.tips.continue":
    "Используйте {highlight}lfcode --continue{/highlight}, чтобы продолжить последнюю сессию",
  "tui.tips.attach_cli":
    "Используйте {highlight}lfcode run -f file.ts{/highlight}, чтобы прикрепить файлы из командной строки",
  "tui.tips.format_json":
    "Используйте {highlight}--format json{/highlight} для машинно-читаемого вывода в скриптах",
  "tui.tips.serve":
    "Запустите {highlight}lfcode serve{/highlight} для headless-доступа к API Lfcode",
  "tui.tips.attach_server":
    "Используйте {highlight}lfcode run --attach{/highlight}, чтобы подключиться к запущенному серверу",
  "tui.tips.upgrade":
    "Выполните {highlight}lfcode upgrade{/highlight}, чтобы обновиться до последней версии",
  "tui.tips.auth_list":
    "Выполните {highlight}lfcode auth list{/highlight}, чтобы увидеть всех настроенных провайдеров",
  "tui.tips.agent_create":
    "Выполните {highlight}lfcode agent create{/highlight}, чтобы создать агента в пошаговом режиме",
  "tui.tips.github_trigger":
    "Используйте {highlight}/lfcode{/highlight} в issue/PR на GitHub, чтобы запускать AI-действия",
  "tui.tips.github_install":
    "Выполните {highlight}lfcode github install{/highlight}, чтобы настроить GitHub-workflow",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.lfcode/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Выполните {highlight}lfcode debug config{/highlight}, чтобы диагностировать проблемы конфигурации",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker": "Запускайте Lfcode в контейнерной среде для изолированной разработки",
  "tui.tips.zen":
    "Используйте {highlight}/connect{/highlight} с Lfcode Zen для подобранных и протестированных моделей",
  "tui.tips.agents_md":
  ...
  "tui.command.lfcode.status.title": "Посмотреть статус",
  ...
  "tui.voice.error.no_auth": "Сначала выберите настроенную OpenAI-совместимую модель с поддержкой аудио",
