...
export const dict = {
  ...
  "tui.tips.share":
    "Ejecuta {highlight}/share{/highlight} para crear un enlace público a tu conversación en lfcode.ai",
  ...
  "tui.tips.config_files":
    "Crea {highlight}lfcode.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/lfcode/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "Lfcode gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.lfcode/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.lsp": "Lfcode usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.lfcode/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.lfcode/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a Lfcode leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}lfcode run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}lfcode --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}lfcode run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}lfcode serve{/highlight} para acceso headless a la API de Lfcode",
  "tui.tips.attach_server":
    "Usa {highlight}lfcode run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}lfcode upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}lfcode auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}lfcode agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_trigger":
    "Usa {highlight}/lfcode{/highlight} en issues/PR de GitHub para disparar acciones de IA",
  "tui.tips.github_install":
    "Ejecuta {highlight}lfcode github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.lfcode/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}lfcode debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.command.lfcode.status.title": "Ver estado",
