export const dict: Record<string, string> = {
  ...
  "tui.tips.share": "Run {highlight}/share{/highlight} to create a public link to your conversation at lfcode.ai",
  ...
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/lfcode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "Lfcode auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.lfcode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.lsp": "Lfcode uses LSP servers for intelligent code analysis",
  ...
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.lfcode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Lfcode from reading sensitive files",
  "tui.tips.run": "Use {highlight}lfcode run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}lfcode --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}lfcode run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}lfcode serve{/highlight} for headless API access to Lfcode",
  "tui.tips.attach_server": "Use {highlight}lfcode run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}lfcode upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}lfcode auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}lfcode agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/lfcode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}lfcode github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.lfcode/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}lfcode debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.docker": "Run Lfcode in your container environment for isolated development",
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Lfcode Zen for curated, tested models",
  ...
  "tui.command.lfcode.status.title": "View status",
  ...
  "tui.voice.error.no_auth": "Select a configured OpenAI-compatible model with audio input first",
  "tui.voice.error.no_recorder": "No recording tool found, please install sox",
  "tui.voice.install.title": "Install recorder",
  "tui.voice.install.message":
    "No local recorder is available. Install the managed SoX runtime now and continue with voice input after it finishes?",
  "tui.voice.install.confirm": "install",
  "tui.voice.install.installing": "Installing managed SoX...",
  "tui.voice.install.success": "Managed SoX installed. Voice input can continue now.",
  "tui.voice.install.failed": "Failed to install managed SoX:",
