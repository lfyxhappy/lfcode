...
export const dict = {
  ...
  "tui.tips.share": "{highlight}/share{/highlight} を実行すると lfcode.ai に会話の公開リンクを作成します",
  ...
  "tui.tips.config_files":
    "サーバ設定は {highlight}lfcode.json{/highlight}、TUI 設定は {highlight}tui.json{/highlight} を作成します",
  "tui.tips.global_config":
    "TUI 設定をグローバルに置くなら {highlight}~/.config/lfcode/tui.json{/highlight} を使います",
  ...
  "tui.tips.mcp_oauth": "Lfcode は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  "tui.tips.custom_command":
    "{highlight}.lfcode/command/{/highlight} に {highlight}.md{/highlight} ファイルを追加すると再利用可能なカスタムプロンプトを定義できます",
  ...
  "tui.tips.lsp": "Lfcode はインテリジェントなコード解析に LSP サーバを使います",
  "tui.tips.custom_tool":
    "{highlight}.lfcode/tools/{/highlight} に {highlight}.ts{/highlight} ファイルを作って新しい LLM ツールを定義します",
  "tui.tips.tool_scripts": "ツール定義から Python、Go などのスクリプトを呼び出せます",
  "tui.tips.plugins":
    "{highlight}.lfcode/plugin/{/highlight} に {highlight}.ts{/highlight} ファイルを追加してイベントフックを実装できます",
  "tui.tips.plugin_notify": "プラグインでセッション完了時に OS 通知を送れます",
  "tui.tips.plugin_protect": "プラグインを書いて Lfcode が機密ファイルを読まないようにできます",
  "tui.tips.run": "{highlight}lfcode run{/highlight} で非対話的なスクリプト実行ができます",
  "tui.tips.continue": "{highlight}lfcode --continue{/highlight} で前回のセッションを再開します",
  "tui.tips.attach_cli": "{highlight}lfcode run -f file.ts{/highlight} で CLI からファイルを添付できます",
  "tui.tips.format_json": "{highlight}--format json{/highlight} を使うとスクリプトで機械可読な出力を得られます",
  "tui.tips.serve": "{highlight}lfcode serve{/highlight} を実行するとヘッドレスで Lfcode API にアクセスできます",
  "tui.tips.attach_server": "{highlight}lfcode run --attach{/highlight} で起動中のサーバに接続します",
  "tui.tips.upgrade": "{highlight}lfcode upgrade{/highlight} で最新バージョンに更新します",
  "tui.tips.auth_list": "{highlight}lfcode auth list{/highlight} で設定済みプロバイダを確認します",
  "tui.tips.agent_create": "{highlight}lfcode agent create{/highlight} でガイド付きエージェント作成を行います",
  "tui.tips.github_trigger": "GitHub の issue/PR で {highlight}/lfcode{/highlight} を入力すると AI を起動します",
  "tui.tips.github_install": "{highlight}lfcode github install{/highlight} で GitHub workflow を設定します",
  ...
  "tui.tips.theme_files": "{highlight}.lfcode/themes/{/highlight} ディレクトリに JSON テーマファイルを作成します",
  ...
  "tui.tips.debug_config": "{highlight}lfcode debug config{/highlight} で設定の問題を調査します",
  ...
  "tui.command.lfcode.status.title": "ステータスを表示",
