...
function pagerCmd(): string[] {
  ...
  if (Flag.LFCODE_GIT_BASH_PATH) {
    const less = path.join(Flag.LFCODE_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into lfcode",
  builder: (yargs: Argv) =>
    yargs.option("force", {
