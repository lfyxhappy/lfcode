...
const PACKAGE_NAME = "@lfcode-ai/cli"
...
export const USER_AGENT = `lfcode/${InstallationChannel}/${InstallationVersion}/${Flag.LFCODE_CLIENT}`
...
// TODO(lfcode): uncomment when corresponding channels are supported
...
export class Service extends Context.Service<Service, Interface>()("@lfcode/Installation") {}
  ...
  Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const methodImpl = Effect.fn("Installation.method")(function* () {
        if (process.execPath.includes(path.join(".lfcode", "bin"))) return "curl" as Method
      ...
      const latestImpl = Effect.fn("Installation.latest")(function* (installMethod?: Method) {
        ...
        //     HttpClientRequest.get("https://formulae.brew.sh/api/formula/lfcode.json").pipe(
      ...
      const upgradeImpl = Effect.fn("Installation.upgrade")(function* (m: Method, target: string) {
        ...
        if (!result || result.code !== 0) {
          // TODO(lfcode): restore choco-specific error when choco channel is supported
