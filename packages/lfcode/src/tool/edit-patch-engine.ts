...
/**
 * Internal structured-patch engine for edit.operation=patch. It deliberately
 * has no Tool.define boundary: models can only reach it through `edit`.
 */
export const applyEditPatch = (params: z.infer<typeof PatchParams>, ctx: Tool.Context) =>
  Effect.gen(function* () {
