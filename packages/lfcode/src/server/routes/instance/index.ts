...
export const InstanceRoutes = (upgrade: UpgradeWebSocket): Hono => {
  ...
  // Desktop bootstrapping depends on the stable instance routes. The experimental
  // HttpApi shadow handlers are still incomplete and have caused empty recent-project
  // state when they intercept `/project` and related bootstrap reads.
  if (Flag.LFCODE_EXPERIMENTAL_HTTPAPI && Flag.LFCODE_CLIENT !== "desktop") {
  ...
  return app
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current Lfcode instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the Lfcode instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the Lfcode system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the Lfcode system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the Lfcode system.",
