  ...
  new Hono()
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Return only aggregated usage totals without trend, heatmap, or log rows.",
        ...
        responses: {
          200: {
            ...
            content: {
              "application/json": {
                schema: resolver(SessionUsage.Summary),
              },
            },
          },
          ...errors(400),
      ...
      async (c) =>
        jsonRequest("UsageRoutes.summary", c, function* () {
          return SessionUsage.summary(c.req.valid("query"))
        }),
    )
