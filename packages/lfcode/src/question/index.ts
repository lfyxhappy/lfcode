...
export class Info extends Schema.Class<Info>("QuestionInfo")({
  ...
  params: Schema.optional(Schema.Record(Schema.String, Schema.String)).annotate({
    description: "Template parameters for i18n interpolation (e.g. { plan: '.lfcode/plans/...' })",
  }),
}) {
  static readonly zod = zod(this)
}
...
export class Service extends Context.Service<Service, Interface>()("@lfcode/Question") {}
