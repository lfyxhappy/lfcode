import type * as SDK from "@lfcode-ai/sdk/v2"
...
const disabled = process.env["LFCODE_DISABLE_SHARE"] === "true" || process.env["LFCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@lfcode/ShareNext") {}
