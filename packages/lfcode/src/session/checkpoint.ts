...
export class Service extends Context.Service<Service, Interface>()("@lfcode/SessionCheckpoint") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const tryStartCheckpointWriter: (
      ...
      // and same-message.id thinking blocks aren't split. Lfcode's ToolPart
