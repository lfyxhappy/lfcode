...
const cli = yargs(args)
  ...
  .middleware(async (opts) => {
    ...
    process.env.AGENT = "1"
    process.env.LFCODE = "1"
    process.env.LFCODE_PID = String(process.pid)

    Log.Default.info("lfcode", {
    ...
    if (!process.env.LFCODE_DISABLE_CLAUDE_IMPORT && !process.env.LFCODE_CLAUDE_IMPORTED) {
      process.env.LFCODE_CLAUDE_IMPORTED = "1"
      try {
