...
/** Intentional public native API for Effect applications embedding Lfcode. */
export class Service extends Context.Service<Service, Interface>()("@lfcode/public/Lfcode") {}
...
>()("@lfcode/public/Lfcode/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("Lfcode.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("Lfcode.sessions.switchModel")(function* (input) {
...
// TODO: Add Lfcode.create(...) as the Promise facade over the same native API semantics.
