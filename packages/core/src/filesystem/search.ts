...
export class Service extends Context.Service<Service, Interface>()("@lfcode/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.LFCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
