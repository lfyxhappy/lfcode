...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof LFCODE_LIBC === "undefined" ? undefined : LFCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@lfcode/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.LFCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
