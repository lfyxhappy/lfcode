...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@lfcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@lfcode/v2/ToolRegistry") {}
