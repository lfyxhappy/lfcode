...
const opencodeClient = process.env.LFCODE_CLIENT

afterEach(() => {
  if (otelResourceAttributes === undefined) delete process.env.OTEL_RESOURCE_ATTRIBUTES
  else process.env.OTEL_RESOURCE_ATTRIBUTES = otelResourceAttributes

  if (opencodeClient === undefined) delete process.env.LFCODE_CLIENT
  else process.env.LFCODE_CLIENT = opencodeClient
})
