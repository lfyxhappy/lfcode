import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@lfcode-ai/sdk/v2"
import { SessionTurn } from "@lfcode-ai/ui/session-turn"
import { SessionReview } from "@lfcode-ai/ui/session-review"
import { DataProvider } from "@lfcode-ai/ui/context"
import { FileComponentProvider } from "@lfcode-ai/ui/context/file"
import { WorkerPoolProvider } from "@lfcode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@lfcode-ai/ui/logo"
...
import { Binary } from "@lfcode-ai/core/util/binary"
import { NamedError } from "@lfcode-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@lfcode-ai/ui/tabs"
import { MessageNav } from "@lfcode-ai/ui/message-nav"
import { FileSSR } from "@lfcode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@lfcode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/lfcode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })
          ...
          return (
            <>
              ...
              <Meta name="description" content="Lfcode - The AI coding agent built for the terminal." />
