...
> Este README localizado acompanha o estado atual do repositorio Lfcode para manter corretos os links de download, os arquivos de release e as notas de compatibilidade.
